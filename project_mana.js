        ...
        connectors: [{
            ...
            options: {
                data: [
                    ...
                    [Date.UTC(2024, 4, 1), 0, 156, 30],
                    [Date.UTC(2024, 4, 8), 23, 134, 30],
                    [Date.UTC(2024, 4, 15), 45, 111, 30],
                    [Date.UTC(2024, 4, 22), 68, 89, 13],
                    [Date.UTC(2024, 4, 29), 85, 93, 2],
                    [Date.UTC(2024, 5, 5), 113, 51, 8],
                    [Date.UTC(2024, 5, 12), null, 51, 8]
                ]
            }
        }, {
            id: 'taskByAssignee',
